 ...
 * <p>
 * Convierte las excepciones lanzadas por controladores y servicios en respuestas
 ...
 * <p>
 * Spring elige el handler según el tipo de excepción más específico, sin importar
...
public class GlobalExceptionHandler {
    ...
    /** Errores de autorización (@PreAuthorize, etc.) -> 403, sin exponer detalles internos. */
    ...
    /** Errores de lógica de negocio lanzados por los servicios -> 400, con el mensaje original. */
     ...
     * {@link IllegalArgumentException} para indicar que el ID/recurso buscado no existe.
     */
    ...
    /** Un parámetro o variable de ruta tiene un tipo de dato incorrecto (ej. texto donde se espera un ID numérico) -> 400. */
    ...
    /** Falla la validación de un @RequestBody anotado con @Valid -> 400, con el detalle por campo. */
    ...
    /** Se llamó a un endpoint existente con un método HTTP no soportado (ej. DELETE en vez de POST) -> 405. */
    ...
    /** Catch-all de seguridad para cualquier error no controlado -> 500, sin exponer detalles al cliente. */
